...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`idtipocliente`) REFERENCES `tipoclientes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of clientes
-- ----------------------------
INSERT INTO `clientes` VALUES ('1', '1', '1', 'DENYS', 'GUERRERO', '0', 'M', '', '', null);
...
CREATE TABLE `compras` (
  ...
  `adelanto` decimal(18,3) NOT NULL,
  `estadopago` tinyint(4) NOT NULL,
  `fechaemision` datetime NOT NULL,
  `descuento` decimal(18,3) NOT NULL,
  `total` decimal(18,3) NOT NULL,
  `confirmar` datetime DEFAULT NULL,
  `estado` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `compras_idproveedor_foreign` (`idproveedor`),
  KEY `compras_idtipopago_foreign` (`idtipopago`),
  KEY `compras_idtipodoc_foreign` (`idtipodoc`),
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`idproveedor`) REFERENCES `proveedors` (`id`),
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`idtipodoc`) REFERENCES `tipocomprobantes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `conceptos` (
  ...
  CONSTRAINT `conceptos_ibfk_1` FOREIGN KEY (`idtipoconcepto`) REFERENCES `tipoconceptos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of conceptos
-- ----------------------------
INSERT INTO `conceptos` VALUES ('1', '1', 'Venta de Productos', null);
INSERT INTO `conceptos` VALUES ('2', '2', 'Compra de Productos', null);
INSERT INTO `conceptos` VALUES ('3', '2', 'Gastos', null);
INSERT INTO `conceptos` VALUES ('4', '1', 'Devolución Proveedores', null);
INSERT INTO `conceptos` VALUES ('5', '2', 'Devolucion Clientes', null);
INSERT INTO `conceptos` VALUES ('6', '1', 'denys', null);
...
CREATE TABLE `detcompras` (
  ...
  CONSTRAINT `detcompras_ibfk_1` FOREIGN KEY (`idproducto`) REFERENCES `productos` (`id`),
  CONSTRAINT `detcompras_ibfk_2` FOREIGN KEY (`idcompra`) REFERENCES `compras` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `detventas` (
  ...
  CONSTRAINT `detventas_ibfk_1` FOREIGN KEY (`idproducto`) REFERENCES `productos` (`id`),
  CONSTRAINT `detventas_ibfk_3` FOREIGN KEY (`idventa`) REFERENCES `ventas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `movimientodineros` (
  ...
  CONSTRAINT `movimientodineros_ibfk_1` FOREIGN KEY (`idcaja`) REFERENCES `cajas` (`id`),
  CONSTRAINT `movimientodineros_ibfk_2` FOREIGN KEY (`idconcepto`) REFERENCES `conceptos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `productos` VALUES ('3', 'tornillo', '0.000', '41', '10', '0');
...
-- ----------------------------
INSERT INTO `proveedors` VALUES ('1', 'INVENTARIO INICIAL', 'TARAPOTO', 'pasarela@hotmail.com', '10445382375', 'Jr. Alonso de alvarado', null);
...
-- Records of series
-- ----------------------------
INSERT INTO `series` VALUES ('1', '001', '8', '1', '1000', null);
INSERT INTO `series` VALUES ('2', '001', '0', '4', '100000000', null);
INSERT INTO `series` VALUES ('3', '001', '0', '1', '100000000', null);
INSERT INTO `series` VALUES ('4', '001', '6', '6', '10000000000000', null);
...
-- ----------------------------
INSERT INTO `tipoclientes` VALUES ('1', 'Natural', '1');
...
-- ----------------------------
INSERT INTO `tipocomprobantes` VALUES ('1', 'Boleta', null);
INSERT INTO `tipocomprobantes` VALUES ('2', 'Factura', null);
INSERT INTO `tipocomprobantes` VALUES ('3', 'Guía de Remisión', null);
INSERT INTO `tipocomprobantes` VALUES ('4', 'Factura', null);
INSERT INTO `tipocomprobantes` VALUES ('5', 'Entrada', null);
INSERT INTO `tipocomprobantes` VALUES ('6', 'Ticket', null);
...
-- ----------------------------
INSERT INTO `tipoconceptos` VALUES ('1', 'Ingreso', null);
INSERT INTO `tipoconceptos` VALUES ('2', 'Egreso', null);
INSERT INTO `tipoconceptos` VALUES ('3', 'Nuevos', null);
...
CREATE TABLE `tipomovimientos` (
  ...
  `estado` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tipomovimientos_idpadre_foreign` (`idpadre`),
  CONSTRAINT `tipomovimientos_ibfk_1` FOREIGN KEY (`idpadre`) REFERENCES `tipomovimientos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of tipomovimientos
-- ----------------------------
INSERT INTO `tipomovimientos` VALUES ('1', 'Tipo Padre', '1', null);
INSERT INTO `tipomovimientos` VALUES ('2', 'Entrada', '1', null);
INSERT INTO `tipomovimientos` VALUES ('3', 'Salida', '1', null);
INSERT INTO `tipomovimientos` VALUES ('4', 'Salida de Almacen', '3', null);
INSERT INTO `tipomovimientos` VALUES ('5', 'Devolución', '2', null);
INSERT INTO `tipomovimientos` VALUES ('6', 'Traslado a otro Almacen', '3', null);
INSERT INTO `tipomovimientos` VALUES ('7', 'Entrada a Almacen', '2', null);
INSERT INTO `tipomovimientos` VALUES ('8', 'Devolución a Proveedores', '3', null);
...
CREATE TABLE `ventas` (
  ...
  `estadopago` tinyint(4) NOT NULL DEFAULT '0',
  `estado_v` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
