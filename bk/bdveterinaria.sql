...
-- Records of animal
-- ----------------------------
INSERT INTO `animal` VALUES ('1', '1', 'asdH', 'asd', 'H', '2015-02-11', '0', '0', 'as', 'asdasd', 'asdas', '1', '3', '1', '4', '1', '1', '1');
INSERT INTO `animal` VALUES ('2', '2', 'asdaM', 'asd', 'M', '2015-02-17', '0', '0', 'asd', 'sadasd', 'asd', '1', '3', '1', '4', '1', '1', '1');
INSERT INTO `animal` VALUES ('3', '3', 'ASDBBBBBBBBASD', 'SAD', 'M', '2015-02-05', '1', '1', 'AS', 'ASDASD', 'ASDASDAD', '1', '3', '1', '4', '1', '1', '1');
...
INSERT INTO `bajas` VALUES ('3', '2', 'TTTTT', '1', '2015-02-28');
...
-- ----------------------------
INSERT INTO `enfermedades` VALUES ('1', 'ASDSAD', '1', '1', '2');
INSERT INTO `enfermedades` VALUES ('2', 'DDDDDDD', '1', '1', '2');
INSERT INTO `enfermedades` VALUES ('3', 'CCCCC', '1', '2', '2');
...
-- ----------------------------
INSERT INTO `lactancias` VALUES ('1', null, null, null, '0000-00-00');
INSERT INTO `lactancias` VALUES ('2', '                                SDFSDFSDFSDF EE             ', '1', '1', '2015-03-03');
INSERT INTO `lactancias` VALUES ('3', 'BBBBBBBB', '1', '1', '2015-04-10');
INSERT INTO `lactancias` VALUES ('4', null, null, null, null);
...
INSERT INTO `lotes` VALUES ('3', 'ASDA', '5', '1');
INSERT INTO `lotes` VALUES ('4', 'CCCC', '3', '1');
...
INSERT INTO `modulos` VALUES ('1', 'SEGURIDAD', '#', '1', '0', 'FA  FA-COGS FA-LG ', '7');
...
INSERT INTO `modulos` VALUES ('26', 'DOCUMENTO', '#', '0', '0', 'FA  FA-DOWNLOAD FA-LG', '0');
INSERT INTO `modulos` VALUES ('27', 'SEMANAL', 'REPORTE_SEMANAL', '0', '26', '', null);
INSERT INTO `modulos` VALUES ('28', 'ANIO', 'ANIO', '0', '18', '', null);
INSERT INTO `modulos` VALUES ('29', 'NOTIFICACIONES', '#', '0', '0', 'FA   FA-BELL FA-LG', '0');
INSERT INTO `modulos` VALUES ('30', 'AVISOS', 'NOTIFICACION', '0', '29', '', null);
INSERT INTO `modulos` VALUES ('31', 'CONTRATOS', '#', '0', '0', 'FA FA-USER FA-LG', '0');
...
INSERT INTO `modulos` VALUES ('39', 'MANTENIMIENTO', '#', '1', '0', 'FA FA-WRENCH FA-LG ', null);
...
INSERT INTO `modulos` VALUES ('46', 'CONTROL', '#', '1', '0', 'FA FA-DASHBOARD FA-LG', '6');
INSERT INTO `modulos` VALUES ('47', 'PRODUCCION', '#', '1', '0', 'FA FA-HOME FA-LG', '5');
...
INSERT INTO `modulos` VALUES ('54', 'CONTROL MATERNO', 'CONTROLMATERNO', '1', '46', '', null);
INSERT INTO `modulos` VALUES ('55', 'REPORTE', '#', '1', '0', 'FA FA-BAR-CHART-O FA-LG', '2');
INSERT INTO `modulos` VALUES ('56', 'REPORTE DE ANIMALES POR PARIR', 'REPORTE1', '1', '55', '', null);
INSERT INTO `modulos` VALUES ('57', 'REGISTRO DE BAJAS', 'REPORTE2', '1', '55', '', null);
INSERT INTO `modulos` VALUES ('58', 'REPORTE DE NACIMIENTOS', 'REPORTE3', '1', '55', '', null);
...
INSERT INTO `permisos` VALUES ('1', '54', '1');
INSERT INTO `permisos` VALUES ('1', '52', '1');
INSERT INTO `permisos` VALUES ('1', '53', '1');
INSERT INTO `permisos` VALUES ('1', '51', '1');
INSERT INTO `permisos` VALUES ('1', '56', '1');
INSERT INTO `permisos` VALUES ('1', '57', '1');
INSERT INTO `permisos` VALUES ('1', '58', '1');
...
CREATE TABLE `producciones` (
  ...
  KEY `idanimal` (`idanimal`),
  CONSTRAINT `producciones_ibfk_1` FOREIGN KEY (`idanimal`) REFERENCES `animal` (`idanimal`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of producciones
-- ----------------------------
INSERT INTO `producciones` VALUES ('4', 'ASD', '123', '1', '3');
INSERT INTO `producciones` VALUES ('5', 'ASW', '123', '1', '2');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `act_enfermedad`(IN `p_idenfermedad` int,IN `p_descripcion` varchar(200),IN `p_idanimal` int,IN `p_idlote` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `act_lactancia`(IN `p_idlactancia` int,IN `p_descripcion` text,IN `p_idanimal` int,IN `p_fecha` date)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `act_producciones`(IN `p_idproduccion` int,IN `p_descripcion` varchar(200),IN `p_cantidad` int,IN `p_idanimal` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_enfermedad`(IN `p_descripcion` varchar(200),IN `p_idanimal` int,IN `p_idlote` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_lactancia`(IN `p_descripcion` text,IN `p_idanimal` int,IN `p_fecha` date)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_producciones`(IN `p_descripcion` varchar(200),IN `p_cantidad` int,IN `p_idanimal` int)
BEGIN
...
-- ----------------------------
-- Procedure structure for reporte1
-- ----------------------------
DROP PROCEDURE IF EXISTS `reporte1`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporte1`(fecha_i date ,fecha_f date)
BEGIN

SELECT La.*, A.nombre,A.idlote,L.idparcela FROM lactancias AS La
INNER JOIN animal AS A ON A.idanimal=La.idanimal
inner join lotes as L on l.idlote=A.idlote
WHERE La.estado=1 and La.fecha >= fecha_i and  La.fecha <= fecha_f;
END
;;
DELIMITER ;

-- ----------------------------
-- Procedure structure for reporte2
-- ----------------------------
DROP PROCEDURE IF EXISTS `reporte2`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporte2`(p_fecha date)
BEGIN
SELECT B.*, A.nombre FROM bajas AS B
INNER JOIN animal AS A ON A.idanimal=B.idanimal
WHERE B.estado=1 and B.fecha=p_fecha;
END
;;
DELIMITER ;

-- ----------------------------
-- Procedure structure for reporte3
-- ----------------------------
DROP PROCEDURE IF EXISTS `reporte3`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporte3`(p_fecha date)
BEGIN
...
WHERE A.estado=1 and A.fecha_nac=p_fecha;
END
;;
DELIMITER ;
...
THEN
SELECT A.nombre,A.idlote as idlote_i, L.descripcion as lote,L.idparcela, E.* FROM enfermedades AS E
...
SELECT animal.idanimal as id , animal.nombre as descripcion FROM animal
...
SELECT  lotes.idlote as id ,lotes.descripcion as descripcion FROM lotes 
...
THEN
SELECT P.*, A.nombre FROM producciones AS P
...
IF(p_idproduccion <>0 AND p_descripcion ='')
THEN
SELECT P.*, A.nombre,A.idlote,L.idparcela FROM producciones AS P
INNER JOIN animal AS A ON A.idanimal=P.idanimal
INNER JOIN lotes as L on L.idlote=A.idlote
