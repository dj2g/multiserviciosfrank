...
function getDiasFaltantes(fecha_final) {
    var diastotales;
    //fecha de inicio
...
var makeSelectCallback = function (ruta, elemtId,param,callback){
    $.ajax({
        type: 'GET',
        url: url + ruta,
        data: param,
        ...
        success: function (data) {
            ...
            if (data.length > 0) {
                ...
                cadena += '<option value="0">Seleccione1...</option>';
            }
...
var makeSelect = function (url, elemtId, param, callback) {
    $.ajax({
        type: 'GET',
        url: url + url,
        data: param,
...
function selectAjax (id,ruta,idextra,idselect){
  
   idselect.change(function(){
       var param=$(this).val();
   $.get(url+ruta,'id='+param,function(datos){
               var HTML = HTML + '<option>Seleccione.....</option>';
...
function selectAjax2 (id,ruta,idextra,idselect,callback){
