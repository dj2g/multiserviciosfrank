...
<!--                            <input class="m-wrap input-xlarge" type="text" id="buscar" placeholder="Buscar...">-->
                            <input type="text" class="form-control inline" id="buscar" placeholder="Buscar..."   style="width:130px;">
                            <button class="btn btn-inverse" type="button" id="btn_buscar"><i class="icon-search icon-white"></i></button>
                            <a href="<?php echo BASE_URL ?>perfiles/nuevo" class="btn btn-grey"><i class="icon-plus icon-white"></i> Nuevo</a>
                        </div>
                        <br/>
                    </div>
                </div>
                <div id="grilla">
                    <table id="table" class="table table-condensed table-striped table-bordered table-hover no-margin">
                        <thead>
                            <tr>
                                <th>Item</th>
                                <th>Descripcion</th>
                        ...
                        <tbody>
                            <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL ?>perfiles/editar/<?php echo $this->datos[$i]['ID_PERFIL'];?>')"  ><i class="fa fa-edit fa-lg text-success"></i></a>
                                        <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL ?>perfiles/eliminar/<?php echo $this->datos[$i]['ID_PERFIL'];?>')" class="task-del"><i class="fa fa-trash-o fa-lg text-danger"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
