          ...
          <div>
            <div class="row">
              ...
              <input  type="hidden" id="idproveedor" value="" />
                <input class="form-control typeahead tt-query" type="text" id="proveedor_txt" autocomplete="off" placeholder="Buscar cliente..." onkeypress="saltar(this,event,'idtipodoc');" autofocus value="" />
              </div>
              ...
              <div class="col-md-2 spaccing">
                <input type="text" id="nrodoc" name="nrodoc" placeholder="000-0000"  value="001-0001" disabled class="form-control"
