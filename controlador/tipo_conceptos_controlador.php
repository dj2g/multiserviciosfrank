...
class tipo_conceptos_controlador extends controller{
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->_modulos = $this->cargar_modelo('tipo_conceptos');
    }

    public function index() {
        $this->_vista->titulo = 'Tipo de Conceptos';
    ...
    public function allTipo_concepto(){
