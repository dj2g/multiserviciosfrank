...
class tipo_productos_controlador extends controller{
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->_modulos = $this->cargar_modelo('tipo_productos');
    }

    public function index() {
        $this->_vista->titulo = 'Tipo de Productos';
    ...
    public function allTipo_producto(){
