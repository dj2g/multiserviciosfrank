...
class compras_controlador extends controller{
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->_modulos = $this->cargar_modelo('compras');
        $this->tipo_comprobantes = $this->cargar_modelo('tipo_comprobantes');
    }

    public function index() {
        $this->_vista->titulo = 'Compras';
        $this->_vista->datos = $this->tipo_comprobantes->all();
