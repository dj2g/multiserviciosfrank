...
class tipo_comprobantes_controlador extends controller{
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->_modulos = $this->cargar_modelo('tipo_comprobantes');
    }

    public function index() {
        $this->_vista->titulo = 'Tipo de Comprobantes';
    ...
    public function allTipo_Comprobante(){
        echo $this->_modulos->allForTable($_POST);
    }

     public function all(){
        return $this->_modulos->all();
    }
