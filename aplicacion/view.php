...
class view {
    ...
    public function __construct(request $peticion, $menu, $modulo_padre=null,$configs) {
                ...
                echo '
                        <div id="breadcrumbs">
                            <ul class="breadcrumb">
                                <li>';
                if ($uri2 != 'index') {
                    echo "<a href='javascript:;'><span id='name_modulo_padre'></span></a>
                             
                        </li>
                        <li>
                            <a href='" . BASE_URL . $this->_controlador . "'>
                            <span id='name_modulo_hijo'>" . $this->_controlador . " </span>
                            </a>";
                } else {
                    echo '<a href="' . BASE_URL . 'index">Inicio</a>';
                }
